...
public class JsonbStringListConverter implements AttributeConverter<List<String>, String> {
    ...
    public String convertToDatabaseColumn(List<String> attribute) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Error converting List<String> to JSONB String", e);
        }
    }
    ...
    public List<String> convertToEntityAttribute(String dbData) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Error converting JSONB String to List<String>", e);
        }
    }
}
